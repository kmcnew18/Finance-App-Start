...
const FEATURE_PREVIEW_DATA = {
  ...
  savings: {
    ...
    svg: `<svg viewBox="0 0 200 160" width="170" height="150">
      ...
      <ellipse class="fp-sav-leaf fp-anim" cx="45" cy="80" rx="14" ry="8" transform="rotate(-30 45 80)"/>
      <ellipse class="fp-sav-leaf fp-l2 fp-anim" cx="76" cy="60" rx="14" ry="8" transform="rotate(30 76 60)"/>
    </svg>`,
  },
};
